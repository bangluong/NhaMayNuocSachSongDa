...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE chisonuoc SET cs_moi = '$cs_moi' WHERE ma_csn = '$ma_csn'";
    //echo $sql;
    $conn->query($sql);
    ...
    function thanhTien($ma_kh, $cs_nuoc, $ma_csn)
    {
        ...
        $sql2 = "UPDATE hoadon SET  ma_csn = '$ma_csn', 
        luong_tieu_thu = '$cs_nuoc', thanh_tien = '$thanh_tien', 
        thue= '$thue', ngay_tao = '$now', ma_nv ='$ma_nv', trang_thai = 0 
        WHERE ma_csn = '$ma_csn'";
        $conn->query($sql2);
    }
