        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $sql2 = "SELECT *FROM chisonuoc where ma_kh='$id' order by ma_csn DESC LIMIT 2";
                    ...
                    $conn->close();
                    ?>
                    <form action="xuly_SuaChiSoNuoc.php" method="post">
                        ...
                        <div class="form-group col-sm-5">
                            ...
                            <input type="text" readonly name="ten_kh" class="form-control" value="<?php echo $infor['ho_ten'];?>">
                        </div>

                        <div class="form-group col-sm-5">
                            <label>Mã Chỉ Số Cũ:</label>
                            <input type="text" readonly name="ma_csn" class="form-control" value="<?php echo $infor2['ma_csn'];?>">
                        </div>

                        <div class="form-group col-sm-5">
                            <label>Chỉ Số Cũ:</label>
                            <input type="text" readonly name="cs_cu" class="form-control" value="<?php echo $infor2['cs_cu'];?>">
                        </div>

                        <div class="form-group col-sm-5">
                            <label>Chỉ Số Mới:</label>
                            <input type="text" name="cs_moi" class="form-control">
                        </div>
