        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $sql2 = "SELECT *FROM chisonuoc where ma_kh='$id' order by ma_csn DESC LIMIT 1";
                    ...
                    $conn->close();
                    ?>
                    <form action="xuly_ThemChiSoNuoc.php" method="post" name = "myform">
                        ...
                        <div class="form-group col-sm-5">
                            ...
                            <input type="text" readonly name="cs_cu" class="form-control" value="<?php echo $infor2['cs_moi'];?>">
                        </div>
